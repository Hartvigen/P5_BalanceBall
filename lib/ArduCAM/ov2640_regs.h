...
const struct sensor_reg OV2640_QVGA[] PROGMEM =
{
	...
	{0xff, 0x1}, 
	{0x3c, 0x32}, 
	{0x11, 0x80}, // Frequency doubling (0x80). Standard (0x00)
	{0x9, 0x2}, 
	{0x4, 0x28},  // Std(0xa8). Disabled horizontal mirror
	{0x13, 0xe5},
	{0x14, 0x48},
	{0x2c, 0xc},
	{0x33, 0x78}, 
	...
	{0xd7, 0x3}, 
	{0xd9, 0x10}, 
	{0xd3, 0x82}, // Used 0x3d again later???
	{0xc8, 0x8}, 
	{0xc9, 0x80}, 
	{0x7c, 0x0}, 
	{0x7d, 0x0}, 
	...
	{0xda, 0x9}, // std(0x8). Swapped color bytes so arduino don't have to
	{0xd7, 0x3}, 
	{0xe0, 0x0}, 
...
{
	{0xff, 0x01},
{0x12, 0x80}, // First difference from QVGA
{0xff, 0x00},
{0x2c, 0xff},
{0x2e, 0xdf},
{0xff, 0x01},
